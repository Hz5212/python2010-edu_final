        ...
        <div class="cart-info">
            ...
            <div class="cart-item" v-for="course in course_list">
                <el-row>
                    ...
                    <el-col :span="4" class="course-price">¥{{course.expire_price}}
                        <br> 原价：￥{{course.price}}
                    </el-col>
        ...
        methods: {
            ...
            create_order() {
                this.$axios.post(this.$settings.HOST + "order/option/", {
                    ...
                    localStorage.order_number = res.data.order_number
                    ...
                    this.$axios.get(this.$settings.HOST + "payments/pay/", {
                        ...
                        localStorage.site = res.data
                        this.$axios.post(this.$settings.HOST + "payments/site/",{
                            site: localStorage.site,
                            order_number: localStorage.order_number
                        }).then(res=>{
                            console.log(res.data)
                        }).catch(error=>{
                            console.log(error)
